...
class LiteraryWorksScreen extends StatelessWidget {
  const LiteraryWorksScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: AppLocalizations.of(context)!.literary_works),
      body: SafeArea(
        child: Center(
          child: Text(
